...
enqueueCertificateRevision(ruvia::DbTransaction& transaction, std::string_view tenantId,
                           std::string_view certificateId, std::int64_t revision,
    ...
    co_return co_await service::sync_runtime::upsertMarker(
        transaction, tenantId, service::sync_runtime::MarkerResourceType::certificate,
